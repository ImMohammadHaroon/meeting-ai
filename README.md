...
[![Live Demo](https://img.shields.io/badge/Live_Demo-meetingai.dev-blue?style=for-the-badge&logo=vercel)](https://meetingai.dev)
...
The **Live Meeting** feature relies on **WebSockets** via **Socket.io**. Serverless platforms like Vercel's functions **do not support persistent WebSockets**.

For full functionality, the backend must be deployed to a service that supports persistent connections, such as **Railway**, **Render**, or a dedicated VPS. The frontend can be deployed separately to Vercel or Netlify.
