...
type CanvasWithCleanup = HTMLCanvasElement & { cleanupFuzzy?: () => void };
...
export interface Glitchy404Props {
  width?: number;
  height?: number;
  color?: string;
}
...
export function Glitchy404({
  ...
  return (
    <FuzzyWrapper baseIntensity={0.4} className="max-w-full cursor-pointer">
      <div className="relative">
        <svg
          width={width}
          height={height}
